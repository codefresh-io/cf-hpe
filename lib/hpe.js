...
class Hpe {
  ...
  static reportPipelineJobStatus(session, job) {
    const uri = Util.format(
    ...
    const data = {
      serverCiId: job.serverInstanceID,
      jobCiId: job.rootJobID,
      buildCiId: job.buildID,
